...
<body>
  ...
  <script>
    ...
    const state = {
      ...
      railActions: [['⚡', 'Generate', true], ['✂️', 'Split'], ['🎬', 'Scenes'], ['💬', 'Subtitle'], ['🎞️', 'B-Roll'], ['⏱️', 'Speed'], ['🪄', 'Stabilize'], ['🎨', 'Effects'], ['🎵', 'Audio'], ['🔌', 'Plugins'], ['👥', 'Collaborate']],
      chat: [
    ...
    case 'audio':
      content.innerHTML = `
        <div class="p-4 space-y-4">
          ...
          <div class="space-y-3">
            <div class="bg-gray-800 rounded-lg p-3">
              <h4 class="text-white font-medium mb-2">Audio Processing</h4>
              <div class="grid grid-cols-1 gap-2 text-sm">
                <div class="flex items-center gap-2">
                  <span class="text-green-400">✓</span>
                  <span class="text-gray-300">8 Professional effects (EQ, Compressor, Reverb)</span>
                </div>
                <div class="flex items-center gap-2">
                  <span class="text-green-400">✓</span>
                  <span class="text-gray-300">Real-time level meters and automation</span>
                </div>
                <div class="flex items-center gap-2">
                  <span class="text-green-400">✓</span>
                  <span class="text-gray-300">Multi-channel audio routing</span>
                </div>
                <div class="flex items-center gap-2">
                  <span class="text-green-400">✓</span>
            ...
            <button class="w-full bg-green-600 hover:bg-green-700 text-white py-2 px-4 rounded transition-colors">
              🎛️ Open Professional Audio Mixer
            </button>
          </div>
        </div>
      `;
